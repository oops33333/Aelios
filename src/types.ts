export interface Env {
  ...
  // History compression
  ENABLE_HISTORY_COMPRESSION?: string;
  HISTORY_COMPRESS_THRESHOLD?: string;
  HISTORY_KEEP_RECENT?: string;
  HISTORY_COMPRESS_MODEL?: string;
  HISTORY_COMPRESS_MAX_CHARS?: string;
  HISTORY_COMPRESS_CACHE_TTL?: string;
